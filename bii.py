# We draw a ball in the internet.
# Websites form a directed graph via links.
# Starting from center = "somewebsite.com", we follow links to other top-level domains.
# We travel no farther than MAX_DEPTH away from center.
# We record the connectivity (i.e., directed edges) and output the resulting directed graph.
